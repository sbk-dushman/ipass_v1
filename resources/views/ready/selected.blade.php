...
<body>
	...
	.table-box table tr td:last-child button {
		border: none;
		outline: none;
		background:transparent;
	}
	.table-box table tr td:last-child button:focus {
		border: none;
		outline: none;
		background:transparent;
	}
	.table-box table tr td:last-child) button:active {
		border: none;
		outline: none;
		background:transparent;
	}
	...
	.table-box table tr td:nth-child(2) .fa-hard-hat {
		width: 40px;
		font-size: 24px;
		padding-left: 12px;
		padding-left: 4px;
