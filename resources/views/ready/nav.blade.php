...
<nav class="header-nav">
  	<ul class="nav-list">
    	<li>
		<a class="nav-link" href="/group"title="Поиск по базе">
    ...
    <li>
      <a class="nav-link" href="/workers"><svg xmlns="http://www.w3.org/2000/svg" version="1.0"  viewBox="0 0 769 980" preserveAspectRatio="xMidYMid meet">
        <g>
